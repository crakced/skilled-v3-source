...
public class StorageESP extends Module
{
    ...
    public void onRenderEvent(final RenderWorldLastEvent event) {
        final Iterator<TileEntity> iterator = this.mc.field_71441_e.field_147482_g.iterator();
        while (iterator.hasNext()) {
            final TileEntity tileEntity;
            if ((tileEntity = iterator.next()) instanceof TileEntity && !this.shouldDraw(tileEntity)) {
                continue;
            }
            final RenderManager renderthing = this.mc.func_175598_ae();
            ...
            final double x = tileEntity.func_174877_v().func_177958_n() - renderPosX;
            final double y = tileEntity.func_174877_v().func_177956_o() - renderPosY;
            final double z = tileEntity.func_174877_v().func_177952_p() - renderPosZ;
            ...
            if (tileEntity instanceof TileEntityChest) {
                ...
                if (chest.field_145992_i != null) {
                    ...
                    if (chest.field_145992_i != null || chest.field_145991_k != null || chest.field_145990_j != null) {
                        continue;
                    }
