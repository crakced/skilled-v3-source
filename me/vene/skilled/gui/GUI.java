 ...
 import org.lwjgl.opengl.GL11;
  ...
  public class GUI extends GuiScreen
    ...
    public void func_73863_a(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        for (final Frame frame : this.frames) {
            ...
            if (frame.category.getID() == 1) {
                ...
                if (GUI.renderShit && !Module.getModule(Array.class).getState()) {
                    GL11.glPushMatrix();
                    Minecraft.func_71410_x().field_71466_p.func_78276_b("Arraylist is disabled!", GUI.arrayXPos + 2, GUI.arrayYPos + 16, -1);
                    GL11.glPopMatrix();
                }
                frame.renderFrame();
            }
        ...
        font.renderCenteredText("Test", new Vector2f((float)(this.field_146294_l / 2), (float)(this.field_146295_m / 2)), new Vector4f(255.0f, 255.0f, 0.0f, 0.0f), 20.0);
    }
