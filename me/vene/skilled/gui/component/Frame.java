...
public class Frame
{
    ...
    public void renderFrame() {
        ...
        GL11.glPushMatrix();
        Minecraft.func_71410_x().field_71466_p.func_175063_a(StringRegistry.register(this.category.getName()), (float)(this.getX() + this.getWidth() / 2 - Minecraft.func_71410_x().field_71466_p.func_78256_a(this.category.getName()) / 2), (float)(this.y + 1.5), ClickGUI.getColor());
        Minecraft.func_71410_x().field_71466_p.func_175063_a(this.open ? "-" : "+", (float)(this.x + this.getWidth() - 10), (float)(this.y + 1.5), ClickGUI.getColor());
        GL11.glPopMatrix();
